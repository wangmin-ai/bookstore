	        					...
	        					<div class="row">
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						...
			        						<div class="product__content">
			        							<h4><a href="single-product.jsp">Strive Shoulder Pack</a></h4>
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						...
			        						<div class="product__content">
			        							<h4><a href="single-product.jsp">Voyage Yoga Bag</a></h4>
			        							<ul class="rating d-flex">
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						...
			        						<div class="product__content">
			        							<h4><a href="single-product.jsp">Impulse Duffle</a></h4>
			        							<ul class="rating d-flex">
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						...
			        						<div class="product__content">
			        							<h4><a href="single-product.jsp">Beginner's Yoga</a></h4>
			        							<ul class="rating d-flex">
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						<div class="product__thumb">
			        							<a class="first__img" href="single-product.jsp"><img src="images/product/5.jpg" alt="product image"></a>
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						<div class="product__thumb">
			        							<a class="first__img" href="single-product.jsp"><img src="images/product/7.jpg" alt="product image"></a>
			        							<a class="second__img animation1" href="single-product.jsp"><img src="images/product/2.jpg" alt="product image"></a>
			        							<div class="new__box">
			        								<span class="new-label">new</span>
			        							</div>
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						<div class="product__thumb">
			        							<a class="first__img" href="single-product.jsp"><img src="images/product/10.jpg" alt="product image"></a>
			        							<a class="second__img animation1" href="single-product.jsp"><img src="images/product/2.jpg" alt="product image"></a>
			        							<div class="new__box">
			        								<span class="new-label">new</span>
			        							</div>
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						<div class="product__thumb">
			        							<a class="first__img" href="single-product.jsp"><img src="images/product/11.jpg" alt="product image"></a>
			        							<a class="second__img animation1" href="single-product.jsp"><img src="images/product/4.jpg" alt="product image"></a>
			        							<div class="new__box">
			        								<span class="new-label">New</span>
			        							</div>
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						<div class="product__thumb">
			        							<a class="first__img" href="single-product.jsp"><img src="images/product/12.jpg" alt="product image"></a>
			        							<a class="second__img animation1" href="single-product.jsp"><img src="images/product/2.jpg" alt="product image"></a>
			        							<div class="new__box">
			        								<span class="new-label">Hot</span>
			        							</div>
	        				...
	        				<div class="shop-grid tab-pane fade show active" id="nav-list" role="tabpanel">
	        					<div class="list__view__wrapper">
	        						...
	        						<div class="list__view">
	        							...
	        							<div class="content">
	        								<h2><a href="single-product.jsp">adipiscing</a></h2>
	        								<ul class="rating d-flex">
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        						...
	        						<div class="list__view mt--40">
	        							...
	        							<div class="content">
	        								<h2><a href="single-product.jsp">Voyage Yoga Bag</a></h2>
	        								<ul class="rating d-flex">
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        						...
	        						<div class="list__view mt--40">
	        							...
	        							<div class="content">
	        								<h2><a href="single-product.jsp">Impulse Duffle</a></h2>
	        								<ul class="rating d-flex">
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        						...
	        						<div class="list__view mt--40">
	        							...
	        							<div class="content">
	        								<h2><a href="single-product.jsp">Strive Shoulder Pack</a></h2>
	        								<ul class="rating d-flex">
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
